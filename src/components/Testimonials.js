...
const Testimonials = () => {
    return (
        <div className='h-screen bg-[#F4F6F5] overflow-hidden'>
            ...
            <div className=' bg-[#F4F6F5] mt-20 grid grid-cols-1 gap-8 md:grid-cols-2 
             md:gap-12 mx-40 overflow-hidden'>
                <div>
                    <h3 className='text-3xl text-brandPrimary my-6 font-semibold'>SpaceCraft</h3>
                    <p className='text-xl w-96 font-semibold text-brandSecondary my-6'>File storage made easy - including powerful features you won't find anywhere else. Whether you're.</p>
                    <div className='my-6'>
                        <h4 className='text-brandPrimary text-2xl font-semibold my-2'>Larry Diamond</h4>
                        <p className='text-lg text-brandSecondary'>Chief Executive Officer</p>
                    </div>
                </div>
                <div className='w-80 order-last md:order-first overflow-hidden'>
